  ...
  return courseData ? (
    ...
    justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
      ...
      <div className='max-w-xl z-10 text-gray-500'>
        <h1 className='md:text-course-deatails-heading-large text-course-deatails-heading-small font
        semibold text-gray-800'>{courseData.courseTitle}</h1>
      ...
      {/* review and rating */}
       <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
                ...
                courseRatings.length > 1 ? 'rating' : 'rating'})</p>
