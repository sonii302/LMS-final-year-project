...
const Hero = () => {
  return (
    ...
    px-7 md:px-0 space-y-7 text-center bg-gradient-to-b from-cyan-100/70'>
     ...
     <p className='md:block hidden text-gray-500 max-w-2xl mx-auto'>We bring together world-class instructor
      , interactive content, and a supportive community to help you achieve your personal and professional goals.
     </p>
     <p className='md:hidden text-gray-500 max-w-sm mx-auto'>We bring together world-class instructor to help you 
